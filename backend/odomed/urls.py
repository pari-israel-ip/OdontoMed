...
from .views import recuperar_contrasena, cambiar_contrasena, get_usuario_por_email,cita_detail, crear_citas_automaticas, cita_list, recepcionista_create, recepcionista_detail, recepcionista_list, prescripcion_detail, prescripcion_list, prescripcion_create, tratamiento_costo, tratamiento_detail, tratamiento_list,tratamiento_create, odontologo_detail,odontologo_create,diagnostico_list, diagnostico_create, diagnostico_detail, login, rol_list, rol_detail, rol_create,usuario_list,rol_list_paciente,usuario_detail,usuario_create, odontologo_list, paciente_detail,historial_detail, verify_password
...
urlpatterns = [
    ...
    path('odontologo/create/', odontologo_create, name='odontologo_create'),  
    path('odontologo/<int:id_usuario>/', odontologo_detail, name='odontologo_detail'),  
    ...
    path('tratamiento/<int:id_tratamiento>/', tratamiento_detail, name='tratamiento_detail'),  
    path('tratamiento/costo/<int:id_costo>/', tratamiento_costo, name='tratamiento_costo'),  
    path('prescripcion/create/', prescripcion_create, name='prescripcion_create'),  
    path('prescripcion/historial/<int:id_historial>/', prescripcion_list, name='prescripcion_list'),  
    ...
    path('usuario/por-email/', get_usuario_por_email, name='get_usuario_por_email'),
