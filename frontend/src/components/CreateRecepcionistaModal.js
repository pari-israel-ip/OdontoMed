...
const CreateRecepcionistaModal = ({ onClose, onCreate }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const recepcionistaResponse = await axios.post('http://127.0.0.1:8000/odomed/recepcionista/create/', {
                ...newUsuario,
            ...
            const errorMessage = error.response?.data.errors || { general: 'ERROR AL CREAR EL RECEPCIONISTA. INTÉNTELO DE NUEVO MÁS TARDE.' };
    ...
    return (
        <Modal isOpen={true} onClose={onClose}>
            <ModalOverlay />
            <ModalContent>
                <ModalHeader>Crear Nuevo Recepcionista</ModalHeader>
                <ModalCloseButton />
                <ModalBody>
...
export default CreateRecepcionistaModal;
